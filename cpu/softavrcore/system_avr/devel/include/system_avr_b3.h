...
#define SW_LSB          __IOR(IO_BASE_BASIC_IO+0x00)    // switches
#define SW_LSB          __IOR(IO_BASE_BASIC_IO+0x00)    // switches
#define SW_MSB          __IOR(IO_BASE_BASIC_IO+0x01)
#define BUTTONS         __IOR(IO_BASE_BASIC_IO+0x02)    // buttons
#define KEYPAD          __IOR(IO_BASE_BASIC_IO+0x03)    // keypad
#define LED_LSB         __IOR(IO_BASE_BASIC_IO+0x04)    // LEDs
#define LED_MSB         __IOR(IO_BASE_BASIC_IO+0x05)
#define DISPCTRL        __IOR(IO_BASE_BASIC_IO+0x08)    // display control, pattern mode = 0, raw mode = !0
#define DISPLAY0        __IOR(IO_BASE_BASIC_IO+0x0c)    // 7-segment displays
